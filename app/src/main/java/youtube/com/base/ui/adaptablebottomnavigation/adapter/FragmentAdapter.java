package youtube.com.base.ui.adaptablebottomnavigation.adapter;
...
public abstract class FragmentAdapter extends ViewSwapperAdapter {
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		if (fragment != null) {
			LOGW(TAG, "Attaching item #" + itemId + ": f=" + fragment);
			currentTransaction.attach(fragment);
		} else {
			fragment = getItem(position);
			LOGW(TAG, "Adding item #" + itemId + ": f=" + fragment);
	...
	public void destroyItem(ViewGroup container, int position, Object object) {
		...
		LOGW(TAG, "Detaching item #" + getItemId(position) + ": f=" + object
