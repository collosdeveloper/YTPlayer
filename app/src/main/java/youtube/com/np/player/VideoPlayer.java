...
import static youtube.com.np.player.utils.PlayerHelper.formatSpeed;
import static youtube.com.np.player.utils.PlayerHelper.getTimeString;
...
public abstract class VideoPlayer extends BasePlayer
	...
	public void onVideoSizeChanged(int width, int height, int unappliedRotationDegrees, float pixelWidthHeightRatio) {
		LOGD(TAG, "onVideoSizeChanged() called with: width / height = [" + width + " / " + height + " = " + (((float) width) / height) + "], unappliedRotationDegrees = [" + unappliedRotationDegrees + "], pixelWidthHeightRatio = [" + pixelWidthHeightRatio + "]");
	...
	public void onUpdateProgress(int currentProgress, int duration, int bufferPercent) {
		...
		if (bufferPercent % 20 == 0) { // Limit log
			LOGD(TAG, "updateProgress() called with: isVisible = " + isControlsVisible() + ", currentProgress = [" + currentProgress + "], duration = [" + duration + "], bufferPercent = [" + bufferPercent + "]");
		}
	...
	public boolean onMenuItemClick(MenuItem menuItem) {
		LOGD(TAG, "onMenuItemClick() called with: menuItem = [" + menuItem + "], menuItem.getItemId = [" + menuItem.getItemId() + "]");
	...
	public void onQualitySelectorClicked() {
		LOGD(TAG, "onQualitySelectorClicked() called");
	...
	public void onPlaybackSpeedClicked() {
		LOGD(TAG, "onPlaybackSpeedClicked() called");
	...
	public void showAndAnimateControl(final int drawableId, final boolean goneOnEnd) {
		LOGD(TAG, "showAndAnimateControl() called with: drawableId = [" + drawableId + "], goneOnEnd = [" + goneOnEnd + "]");
		if (controlViewAnimator != null && controlViewAnimator.isRunning()) {
			LOGD(TAG, "showAndAnimateControl: controlViewAnimator.isRunning");
